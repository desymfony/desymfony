...
class AdminPonenciaController extends Controller
{
    ...
    public function newAction()
    {
        ...
        if ($peticion->getMethod() == 'POST') {
            ...
            if ($formulario->isValid()) {
                ...
                $peticion->getSession()->setFlash(
                    'notice',
                    'Se ha creado correctamente la ponencia'
                );

                return $this->redirect(
                    $this->generateUrl('admin_ponencia_edit',
                        array(
                            'id' => $ponencia->getId()
                        )
                    )
        ...
        return $this->render(
            'DesymfonyBundle:AdminPonencia:new.html.twig',
            array(
    ...
    public function editAction($id)
    {
        ...
        if (null == $ponencia = $em->find('DesymfonyBundle:Ponencia', $id)) {
            throw new NotFoundHttpException(
                'No existe la ponencia que se quiere modificar'
            );
        }
        ...
        if ($peticion->getMethod() == 'POST') {
            ...
            if ($formulario->isValid()) {
                ...
                return $this->redirect(
                    $this->generateUrl('admin_ponencia_list')
                );
            }
        }
    ...
    public function showAction($id)
    {
        ...
        if (null == $ponencia = $em->find('DesymfonyBundle:Ponencia', $id)) {
            throw new NotFoundHttpException(
                'No existe la ponencia que se quiere ver'
            );
        }
