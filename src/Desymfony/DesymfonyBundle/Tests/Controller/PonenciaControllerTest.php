...
class PonenciaControllerTest extends WebTestCase
{
    public function testIndex()
    {
        ...
        $this->assertEquals(
            ...
            "Status 200 en ponencias"
        );
        $this->assertTrue(
            $crawler->filter('html:contains("Ponencias")')->count() > 0,
            "La vista contiene la palabra Ponencias"
        );
    }
    ...
    public function testPonencia()
    {
        ...
        $this->assertEquals(
            404,
            $client->getResponse()->getStatusCode(),
            "Status 404 para /ponencia y slug inválida"
        );
    ...
    public function testApuntarse()
    {
        ...
        $this->assertEquals(302,
            $client->getResponse()->getStatusCode(),
            'El usuario no registrado es redirigido al login'
        );
