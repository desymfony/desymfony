...
class DNIValidatorTest extends \PHPUnit_Framework_TestCase
{
    public function testIsValid()
    {
        ...
        $this->assertTrue(
            ...
            "La letra del DNI puede ser minúscula"
        );
        $this->assertFalse(
            $dniValidator->isValid(
                "11111111A",
            ...
            "DNI con letra incorrecta no valida"
        );
        $this->assertFalse(
            $dniValidator->isValid(
                "11111111-H",
        ...
        $this->assertFalse(
            ...
            "DNI con letra al principio no valida"
        );
        $this->assertFalse(
            $dniValidator->isValid(
                "11111111 H",
        ...
        $this->assertFalse(
            ...
            "DNI sin letra no valida"
        );
        $this->assertFalse(
            $dniValidator->isValid(
                "11111111111111111111H",
                new DNI()
            ),
            "DNI demasiado largo no valida"
        );
        $this->assertTrue(
            $dniValidator->isValid(
                "11111W",
